...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes)
        ...
        if (qName.equals("node")) {
            ...
            Vertex V = new Vertex(Double.parseDouble(attributes.getValue("lat")),
                    Double.parseDouble(attributes.getValue("lon")),
                    Long.parseLong(attributes.getValue("id")));
            g.graph.add_vertex(V);
            lastVertex = V;
            ...
            lastVertex.setName(name);
            name = GraphDB.normalizeString(name);
            Vertex V = new Vertex(lastVertex.getLat(),lastVertex.getLng(),lastVertex.getId());
            V.setName(lastVertex.getName());
            g.tst.put(name,V);
        }
    }
